...
7. Ouvrir **Composants → Memi Pilates → Mise en route** et configurer le studio unique, la salle, l’instructeur, le type de cours, le cours, une séance future ou un horaire hebdomadaire, puis un forfait. Une séance future publiée est requise avant que l’horaire public puisse afficher le cours.
...
9. Créer des éléments de menu Joomla vers les vues publiques. Dans **Menus → [menu voulu] → Nouveau → Type d’élément de menu → Memi Pilates**, choisir : **Horaire**, **Réservation**, **Acheter un forfait**, **Mon espace client**, **Borne de présence**, **Offre de liste d’attente** ou **Gestion du studio**. Les routes restent ainsi menu-centrées et conservent le template, l’en-tête, le pied de page et les URL SEO du site. Ajouter au minimum Horaire, Acheter un forfait et Mon espace client; limiter Borne de présence au personnel et Gestion du studio aux comptes autorisés.
