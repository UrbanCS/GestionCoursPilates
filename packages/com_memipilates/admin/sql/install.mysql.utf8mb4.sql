...
CREATE TABLE IF NOT EXISTS #__memi_qr_tokens (
  ...
  idempotency_key VARCHAR(128) NULL DEFAULT NULL,
  active_token_key CHAR(64) NULL DEFAULT NULL,
  ...
  UNIQUE KEY uq_memi_qr_tokens_idempotency (idempotency_key),
  UNIQUE KEY uq_memi_qr_tokens_active (active_token_key),
...
CREATE TABLE IF NOT EXISTS #__memi_notifications (
  ...
  KEY idx_memi_notifications_retry (status, next_attempt_at, attempt_count),
