-- Retry the direct-session credit backfill for sites that installed 1.8.13
-- while a session-level credit override differed from the purchased class.
-- A direct checkout always purchases exactly one transferable class credit.
