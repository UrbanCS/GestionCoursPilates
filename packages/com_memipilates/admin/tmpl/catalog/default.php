    ...
    <div class="card mb-4"><div class="card-body">
        ...
        <form action="<?= $formUrl; ?>" method="post" class="row g-3">
            ...
            <?php elseif ($this->entity === 'course_type') : ?>
                ...
                <div class="col-md-8"><label class="form-label">Cours préalables</label><select class="form-select" name="prerequisite_course_type_id"><?= $selectOptions(array_values(array_filter($this->courseTypes, static fn (array $type): bool => (int) ($type['id'] ?? 0) !== $editId)), $value('prerequisite_course_type_id'), true); ?></select><small class="form-text">Laissez vide si ce type de cours est accessible sans préalable.</small></div>
                <div class="col-md-4"><label class="form-label">Nombre de présences requises</label><input min="1" max="100" type="number" class="form-control" name="prerequisite_attendance_count" value="<?= max(1, (int) $value('prerequisite_attendance_count', 5)); ?>"></div>
